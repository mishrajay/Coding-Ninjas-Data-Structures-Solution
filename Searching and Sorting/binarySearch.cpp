...
#include <iostream>
using namespace std;
//binary search works on only sorted array and is a better way of searching than linear search
int binarySearch(int *input, int n, int val)
{
    ...
    while(start<=end){
        int mid=(start+end)/2;
            ...
            if(input[mid]==val){
                return mid;
                //break;  no need to write break coz when mid will be returned no further
