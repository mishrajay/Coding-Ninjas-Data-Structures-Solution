...
class Polynomial {
    ...
    Polynomial operator+(Polynomial const& p) const
    {
        if(size>p.size)
        {
            ...
            Polynomial NewPoly;
            for(int i=0;i<size;i++)
                NewPoly.setCoefficient(i,newpoly[i]);
